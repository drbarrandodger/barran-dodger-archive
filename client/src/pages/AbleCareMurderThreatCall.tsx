...
const TRANSCRIPT_LINES = [
  { speaker: "Support Worker (Car)", text: "Hey Brett, you're just on speaker here in the car with Barron, just kind of reconvening on our conversation before. After the incident that Barron had this morning, I'm actually on my way to the police station now because they left a card and the constable's name but they didn't leave an event number. So Baron would obviously like an event number. So I'm just driving there now and I'm going to get that. Baron's going to wait in the car. However, the point of the phone call was that Baron feels highly unsafe and that he would like more supports — for longer, for today. Is this something we need to call his support coordinator about?" },
  { speaker: "Brett (AbleCare)", text: "It would be yeah, yes, it would be something we would need to speak to the support coordinator about and have a chat with them just to see what we can do. In saying that though, I just do want to put out there that the place is 24 hours staffed as well. And so there is a staff member — I know they're not directly with him. Like, if he ever does have any issues, he's more than welcome to go knock on the door of the staff room and get assistance." },
  { speaker: "Dr. McLean", text: "Can I just intercept there? Danny, the past church pastor and staff member there, rang me today and said, 'What are you doing telling lies about me? I welcomed you into my church and you offend my religion.' I asked for a simple loan — which he's done before — to get some cigarettes, and he just laughed at me. He's not poised to help me whatsoever. If anyone decides to kill me — and it has been documented this morning that that is the case — the police will allow them to enter the property and murder me. Because there's no incident report for the police this morning. That's not bureaucratic oversight. That's a deliberate mechanism to not report this existential threat to my existence. And if AbleCare don't remove me and put me somewhere safe — not as any disabled, vulnerable person in their care that they're legally obligated to care for, but knowing of an attempted assassination — it's quite likely the police will allow that to happen, and that's been proven multiple times before. Then you know, it's hard to ask for help from the very institutions that are causing the harm." },
  { speaker: "Dr. McLean", text: "AbleCare are doing that to me. I can't ask you for help, Brett. You're not going to put anyone else on to keep me company. You're not going to move me to another place. You're not going to make a police report. You're not going to meet your own institutional complicity in this situation — including the last house with AbleCare, with which I also escaped physical violence. And to be fair, someone called the housemate and the fugitive and warned them the police were coming, giving them full flight to escape. Now, because of those actions, there's another three people who want to kill me from the last place. And now another person from this place. That adds to Tony Riddle, Steve Isonides, Hood Merribee, and many other vigilantes that have a price on my head — $10 million in Bitcoin, which I've acknowledged from my surveillance and my whistleblowers who work on the inside." },
  { speaker: "Brett (AbleCare)", text: "Why did you ring her up—" },
  { speaker: "Dr. McLean", text: "—and tell her police were on the way? No police came. I went back there later. No police came. What's the incident report? What's the incident report?" },
  { speaker: "Brett (AbleCare)", text: "For starters, I didn't call the police. That actually wasn't me. It was another staff member. So you need to stop saying that I called the police when I never, ever made contact with the police at all myself." },
  { speaker: "Dr. McLean", text: "Did they catch the guy? Thank you. I appreciate that. Okay. Sorry for my confusion." },
  { speaker: "Brett (AbleCare)", text: "No, that's fine. But you're sitting there saying I constantly don't help — all we do is try and help you. You're in one of the best spots at the moment. It's 24-hour staffed. If there are any issues, you're more than welcome to go to the staff on site." },
  { speaker: "Dr. McLean", text: "I don't feel safe to go outside a locked door." },
  { speaker: "Dr. McLean", text: "If you don't tell her where I am — is it possible? Because this guy that I had sex with has now been exposed in this whole corruption case and he's getting a gang of mates to come to my house and murder me. And the police haven't given an incident report." },
  { speaker: "Brett (AbleCare)", text: "I do just want to say — I think this is one big thing, Barron, and I think it does need to stop — if you're worried about people doing this, you shouldn't be giving out your address to random people. You know what I mean? You're putting—" },
  { speaker: "Dr. McLean", text: "I don't take unsolicited advice from any single person on this earth because I fly this spaceship. It's my life. No one can tell me what to do — which is legal and acceptable in any other human life if it wasn't mine. Not you, not Suki, not anyone. It was an error and it was a mistake. Sure, I'm not perfect. But if you think it's not okay for me to do that, it's not okay for every single government institution and organisation — including the media, the police, the NDIS, every single government department, oversight committees, ASIO, everyone — to target me like this. That's not okay. What I've done is just try to have a normal life when all of you have ganged up on me." },
  { speaker: "Brett (AbleCare)", text: "But it's not about that — because every single address you've lived in, the same incident has occurred where you've given people your address and then all of a sudden they're coming after you. So it's like, why is it a constant recurrence at every new address that you're handing out your address to random people and then coming back to us saying 'these people are after me'?" },
  { speaker: "Dr. McLean", text: "It's my fault. [Pause] How will you keep me safe when the police's incident report doesn't even have an incident number on it?" },
  { speaker: "Support Worker (Car)", text: "I'm going to go in there. Do you want to call Brett from your phone?" },
  { speaker: "Dr. McLean", text: "I want to finish this conversation, please. Brett, where's the Charm Haven place?" },
  { speaker: "Brett (AbleCare)", text: "Charm Haven. Yeah — I think that might be a better option. Can I just add Rachel and Bruce to this call?" },
  { speaker: "Dr. McLean", text: "Sure. Bring them in. This is recording. Yeah." },
  { speaker: "Support Worker (Car)", text: "Charm Haven's where I look after another participant. There's a three bedroom upstairs and then a two bedroom downstairs — completely separate. You can't access one from the other." },
  { speaker: "Dr. McLean", text: "Is it nice? Has it got a yard? We have to find a solution because the police aren't going to protect me if this guy wants to get a gang of mates and murder me." },
  { speaker: "Brett (AbleCare)", text: "Hey, we're back. I couldn't add Larissa, but I've got Rachel on the call. Do you want to explain again what's happening, Barron, and why you don't feel safe?" },
  { speaker: "Dr. McLean", text: "Hi, Rachel. How are you? I've tried to contact you many times as the CEO, but I've had a stonewalling response — just zero response. The situation is this: I'm a political target because I'm a whistleblower, and I'm trying to live a normal life as best I can, which includes meeting people. A situation has occurred where I've been threatened to be killed and the police have come to the house regarding the assassination attempt but they've refused to give me an incident report. I'm expected to go back to the house where I've been told there's 24-hour staff, but that's not possible." },
  { speaker: "Dr. McLean", text: "I'm a whistleblower and I deserve to be physically safe and free from threats of harm. Brett kind of blamed me for being the one who reveals my address. I'm only trying to have a normal life. But is it possible to move me just to the Charm Haven address, please? Because I don't feel safe where I am. I've reported it to police, but I'm pretty sure there's so much institutional complicity that they're not going to protect me. I know this because of the documented assassination attempt with Hood Merribee and Bill Shorten, who the police have protected. Now I live in exile away from my home in Victoria — because of corrupt police, corrupt courts, and a corrupt society. I didn't choose to leave, but the same targeting is continuing, and until someone says 'it's not fair that this happened to a vulnerable person in our care,' I request and demand to be moved to the other address so I can feel safe from this immediate threat. Is that okay?" },
  { speaker: "Rachel (AbleCare CEO)", text: "I need to speak with Laura before I make any decisions. I'll speak with Laura and come back to you. It might take some days or some weeks. Let's see." },
  { speaker: "Dr. McLean", text: "You know they were going to come and kill me today and the police are really not doing anything. You know that, don't you?" },
  { speaker: "Rachel (AbleCare CEO)", text: "If that's against police, they have to do something because they're emergency services. We are not emergency services. We just care—" },
  { speaker: "Dr. McLean", text: "But you're under legal obligation to keep a vulnerable person in your care safe from physical harm. Is that right?" },
  { speaker: "Rachel (AbleCare CEO)", text: "Of course. That's why I want to speak with Laura and come back to you. Even then — it should come from your Public Guardian, not us." },
  { speaker: "Dr. McLean", text: "The Public Guardian are the ones financially abusing me, obstructing legal aid, and one of the key stakeholders in this corrupt targeting. There's an endless cycle of 'refer to the next person' and no one's taking responsibility. I'm telling you this: there's a serious incident that happened this morning and I've been threatened to be killed. Police are not doing anything. This is obviously an issue for AbleCare, because if I'm murdered tonight — which could be likely — I've recorded this call. Everyone will know. I sent an email to every politician and the NDIS and you, saying there's a live murder threat happening — and not a single person responded. And then the documented actual threat. So I predicted this, and now the police won't do anything." },
  { speaker: "Dr. McLean", text: "And if you're going to blame someone else or say 'public guardian' and leave me in that house to be murdered by a credible threat the police won't do anything about — I will publish this recording and you will be jailed for manslaughter. Do you understand?" },
  { speaker: "Rachel (AbleCare CEO)", text: "Who is trying to... who is this threat to you?" },
  { speaker: "Dr. McLean", text: "Why is that important to you?" },
  { speaker: "Rachel (AbleCare CEO)", text: "So we can report it to the police." },
  { speaker: "Dr. McLean", text: "Why haven't you? Can you go back a step — why haven't you reported this to police? I want two things: an incident report from AbleCare to the NDIS — CC to me — about the threat from the last property; and also an incident report from this morning and a police report from AbleCare. I want the receipt numbers and the incident reports, please." },
  { speaker: "Dr. McLean", text: "You do realise my conundrum here of reporting to the same authority that's causing the conditions for my harm. You do understand that as a concept, don't you?" },
  { speaker: "Rachel (AbleCare CEO)", text: "Oh, Barron, I have a call coming in. So—" },
  { speaker: "Dr. McLean", text: "That call doesn't matter. Right now, you're talking with me. It's an internationally significant case and AbleCare are now implicated in refusing to protect a vulnerable person in their care." },
  { speaker: "Rachel (AbleCare CEO)", text: "And I'm — yeah, we'll speak with your public guardian and your support coordinator and we can go from there. Thanks, Barron. [HANGS UP]" },
  { speaker: "Dr. McLean", text: "I need to know when that turnaround time will be because there could be people on the way, and I don't, like the last time, I don't want to go back there." },
  { speaker: "Brett (AbleCare)", text: "I don't think Rachel's in the call anymore, Barry." },
  { speaker: "Dr. McLean", text: "So why has she managed to just — is she tactically agreeing to her role in this by just cutting me off?" },
  { speaker: "Brett (AbleCare)", text: "It's a hard situation. No one's—" },
  { speaker: "Dr. McLean", text: "No one's got a more hard situation than me. Everyone's got jobs, friends, houses, money, rights, human rights, legal rights. What have I got? A whole bunch of agencies, dozens of them, that are supposed to care for me and pay to care for me. And you're saying it's difficult?" },
  { speaker: "Dr. McLean", text: "I'll accept and publish this call and you can go to jail for manslaughter as well as everyone in AbleCare when I'm murdered in a state-sponsored targeted assassination attempt — which is documented — and you and no one else will do anything about it. Do you understand?" },
  { speaker: "Support Worker (Car)", text: "Yeah, I'm going to go in there now and try and get an event number from this morning." },
  { speaker: "Dr. McLean", text: "Sorry for being upset, Brett. I've lost every single person, every single institution — the media, the lawyers, the advocates, the ombudsmen, the National Anti-Corruption Commission, and up to and including the International Criminal Court at The Hague. My phones are intercepted. My house is bugged. Everyone is told: do not help this man." },
  { speaker: "Brett (AbleCare)", text: "Sorry." },
  { speaker: "Dr. McLean", text: "Calm down. I don't need to be told to calm down. I'm sorry for yelling. I'm really a non-violent person. I don't want to cause anyone harm, but harm is happening to me. Can I come and talk to you in person? I'm sick of this remote management. Suki's in Perth. Phillip's in Sydney for the Public Guardian. You're somewhere down the coast. The manager's somewhere in India. There is no one in this world who's got a bit of responsibility and the courage to front up with me in person, have a discussion with me, let me show them the evidence. I'm forced to defend myself in the public domain on a website. Why? Because I'm isolated. There's no single person I can talk to, connect to — not a boss, not a cop, not an ombudsman. I'm trapped in the house. I can't go anywhere. And the support workers — as nice as they usually are — are told: just act within your remit, don't report anything he's saying, and just move on. No one wants to be seen standing with me. Because if they can do this to a 30-year advocate and an artist and an author with a doctorate who's documented everything — and murder him and get away with it — then they can do it to anyone else." },
  { speaker: "Dr. McLean", text: "I don't want to go into the police station. That's baiting. They're baiting me to go in there. Can we just go back to the house? I just need to sit down and have a drink. Brett, can you call the police?" },
  { speaker: "Support Worker (Car)", text: "I'm not going in there now, Brett. I'm driving back to the Long Jetty property." },
  { speaker: "Dr. McLean", text: "Sorry. I'm sorry for yelling. Can you get the incident report please, Brett?" },
  { speaker: "Brett (AbleCare)", text: "Sure." },
  { speaker: "Dr. McLean", text: "Thank you. Sorry for yelling, all right? And the V2K is in the background saying 'give up.' No — they can give up. I worked my entire life helping other people. 35 years. Selfless work for free. And all every person does is serve the corrupt machine. Every cop, every lawyer, every public official. Everyone's in on it. Isn't there any authentic, honest person? I've admitted all my mistakes. Where has anyone admitted theirs? I've asked to be arrested. If you think I've done something wrong, come and arrest me. Why don't they? Because I've done nothing wrong." },
];
      ...
      <div className="bg-gray-900 border-b border-red-500/30 py-12 px-4">
        <div className="max-w-4xl mx-auto print-page">
          <div className="flex flex-wrap gap-2 mb-6 no-print">
            ...
            <Badge className="bg-amber-500/10 text-amber-400 border-amber-500/30 text-xs px-3 py-1">Active Death Threat — Police Non-Action</Badge>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-14 print-page">
        ...
        <section className="bg-gray-900 border border-gray-700 rounded-2xl p-5 no-print">
          ...
          <div className="flex flex-wrap gap-3">
            <div className="flex items-center gap-2"><span className="inline-block w-3 h-3 rounded-full bg-amber-400" /><span className="text-sm text-gray-300">Dr. McLean — Whistleblower / NDIS Participant</span></div>
        ...
        <section className="bg-amber-950/20 border border-amber-500/30 rounded-2xl p-6 md:p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-amber-300 font-bold text-lg uppercase tracking-wider">AI Forensic Significance Statement</h3>
          </div>
            ...
            {TRANSCRIPT_LINES.map((line, i) => {
              ...
              return (
                <div
                  ...
                  className={`transcript-line border-l-4 pl-4 py-3 rounded-r-lg ${borderColor} ${bgColor}`}
                >
