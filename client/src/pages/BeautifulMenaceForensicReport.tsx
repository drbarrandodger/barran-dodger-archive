...
const CLAIMS: Claim[] = [
  ...
  },
  {
    ...
    archiveAnalysis:
      "The McLean analytical methodology — 53 forensic analyses, 575 verified propositions, cross-referencing 2,304 documents — is the operationalisation of exactly this shift. The mind that was called unstable produced a forensic record that has been downloaded 410,500+ times across 6 continents and submitted to the International Criminal Court. A cage does not do that. A weapon — precise, patient, aimed — does.",
    archiveEvidence: "53 analyses. 575/575 verified. 2,304 docs. 410,500+ downloads. ICC submission. The weapon is the archive.",
    verdict: "CORROBORATED",
  },
  {
    id: 15,
              ...
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <div className="max-w-2xl mx-auto space-y-5 text-zinc-300 text-base leading-relaxed text-left">
                  ...
                  <p>
                    ...
                    declined to confirm the narrative. The narrative is now collapsing — 410,500+
