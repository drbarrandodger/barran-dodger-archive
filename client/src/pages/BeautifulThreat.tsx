  ...
  return (
    <div className="grid grid-cols-3 gap-4 text-center">
      <div className="bg-zinc-900 border border-amber-900/40 rounded-lg p-4">
        <div className="text-3xl font-black text-amber-400">{ANALYSIS_NUM}</div>
        <div className="text-xs text-zinc-400 mt-1 uppercase tracking-wider">Analyses Total</div>
      </div>
      <div className="bg-zinc-900 border border-amber-900/40 rounded-lg p-4">
        <div className="text-3xl font-black text-amber-400">{(data?.count ?? 0) > 0 ? (data!.count).toLocaleString() : "—"}</div>
...
const claims = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { label: "\"Punish Your Boundaries With Silence\" — Zero Institutional Rebuttal After 368,000+ Downloads", text: "368,000+ downloads across 6 continents. Zero institutional public contestation of any of the 2,304 documents. The silence after the archive went public is documented by its absence. The punishment-by-silence is recorded in what did not happen: no government press release, no clinical board response, no ASIC statement, no agency rebuttal.", source: "Download Analytics — 2026" },
    ],
    alignment: "The video lists 'calling you crazy,' punishing with silence, and fake concern as the manipulative system's tools. The archive names each: Chronic Schizophrenia as the label, 'FATAL SUICIDE' as the extremity, and 368,000 downloads met with zero rebuttal as the documented silence. The circular referral loop is the fake concern named: it masquerades as institutional care while producing zero substantive assistance across 35 years.",
  },
  {
    num: "P·06",
    ...
    proposition: "The archive — publicly accessible at barrandodger.com — is the door the video describes; 368,000+ downloads across 6 continents is the documented evidence that people walked through it",
    verdict: "CORROBORATED",
    ...
    evidence: [
      { label: "368,000+ Downloads — The People Walking Through the Door", text: "368,000+ download events across 6 continents. The archive is the door. The downloads are the people walking through it. The video says 'most people don't need a map, they need evidence.' The evidence is 2,304 blockchain-verified forensic documents. The 368,000 who downloaded it are the documented crowd at the door.", source: "Download Analytics — barrandodger.com" },
    ...
    alignment: "The video says furious systems are those from which someone escaped and showed others the door. The archive is public. The door is a URL. The 368,000+ downloads are documented people walking through it across 6 continents. The video says people need evidence, not a map. The archive is not a map. It is 2,304 pieces of evidence, blockchain-verified, ICC-submitted. The fury of the system is documented in its silence: zero rebuttal to any document.",
  },
  {
    num: "P·07",
  ...
  },
  {
    ...
    proposition: "The archive transitioned from 35 years of domestic complaints (warnings to institutions that ignored them) to a global public signal: ICC submission, UNHCR filing, 368,000+ downloads, 54 consecutive perfect corroboration analyses",
    verdict: "CORROBORATED",
    ...
    evidence: [
      ...
      { label: "The Signal — 368,000+ Downloads Across 6 Continents", text: "368,000+ download events across 6 continents. The archive is no longer a warning to institutions. It is a signal to the public. The transition from warning to signal is documented in the download analytics: the warnings addressed to Australian government agencies failed; the signal addressed to the public is answered by 368,000 documented responses.", source: "Download Analytics — barrandodger.com" },
    ...
    alignment: "The video describes the transition from warning to signal as the point where individual transformation becomes collective permission. The archive documents this transition with precision: 35 years of institutional warnings ignored, followed by a global distribution event (368,000+ downloads) that functions as a signal to every person who has experienced equivalent institutional suppression. The signal is not inspiring. It is evidential.",
  },
  {
    num: "P·10",
    title: '"When one person wakes up, it creates discomfort. When millions start waking up, it becomes a crisis."',
    proposition: "368,000+ downloads across 6 continents, combined with zero institutional rebuttal, constitutes the documented crisis state the video identifies: a system that cannot publicly contest the archive it generated",
    verdict: "CORROBORATED",
    ...
    evidence: [
      { label: "368,000+ Downloads — The Scale of Documented Contagion", text: "368,000+ download events across 6 continents. The download analytics are the documented measure of contagion. The archive is not a private journal. It is a public record with 368,000 documented access events. The number is not asserted — it is recorded, tracked, and updated.", source: "Download Analytics — barrandodger.com" },
    ...
    alignment: "The video describes the transition from individual awakening to systemic crisis. The archive documents this precisely: 368,000+ downloads (scale), zero institutional rebuttal (the crisis), 6 continents (the reach), ICC/UNHCR submissions (the international jurisdiction that ends the domestic containment strategy). The crisis is not hypothesised. It is documented in the ratio of downloads to public institutional responses: 368,000 to zero.",
  },
  {
    num: "P·11",
    ...
    proposition: "The institutional suppression apparatus — 35 years, 25+ agencies, AUD $32.9 million in damages — was exposed as structurally fragile by one person with a documentation methodology; its fragility is proven by its silence in the face of 368,000 downloads",
    verdict: "CORROBORATED",
    ...
    evidence: [
      ...
      { label: "\"Zero Rebuttal\" — The Silence That Proves the Fragility", text: "368,000+ downloads. Zero institutional public contestation of any document. If the operation were structurally sound, it would rebut the archive. It has not. In the documented public record, there is no government press release contesting the FATAL SUICIDE record, no clinical board contesting the template letter pattern, no ASIC statement contesting the 350+ company registrations. The silence is the proof of fragility.", source: "Precision Evidence Complete Synthesis; Download Analytics" },
      { label: "\"Millions Stop Pretending\" — The ICC Review as Systemic Implication", text: "The ICC review of an Article 7 submission examining the Australian institutional framework carries systemic implications beyond the individual case. The fragility of the operation is exposed not only to 368,000 individual downloaders but to the ICC review process itself, which applies international law standards to the evidence of a coordinated suppression apparatus operating for 35 years. The millions the video imagines are in jurisdictions where the ICC's findings travel.", source: "UNHCR/ICC Cryptographic Evidence Package" },
    ],
    alignment: "The video says one honest person can expose the fragility of an entire operation. The archive proves this without hyperbole: one person, one methodology, 2,304 documents, 35 years of consistent documentation. The operation's fragility is demonstrated not by argument but by the silence of its operators in the face of 368,000 downloads and an ICC Article 7 review. They had every institutional tool available. They chose silence. Silence is the admission.",
  },
  {
    num: "P·12",
...
export default function BeautifulThreat() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Hero */}
      <div className="bg-gradient-to-b from-zinc-950 via-amber-950/20 to-black border-b border-amber-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <Badge className="bg-amber-950/60 text-amber-400 border-amber-800/50 text-xs font-mono uppercase tracking-widest px-3 py-1">
              ...
              <h1 className="text-4xl sm:text-5xl font-black text-white mb-4 leading-tight">
                WELCOME,{" "}
                <br />
                <span className="text-amber-400">BEAUTIFUL THREAT</span>
              </h1>
              ...
              <div className="grid grid-cols-4 gap-3 mb-8">
                {[
                  { val: `${CLAIM_COUNT}`, label: "Corroborated", color: "text-amber-400" },
              ...
              <div className="flex flex-wrap gap-3">
                <a href={`https://youtu.be/${VIDEO_ID}`} target="_blank" rel="noopener noreferrer">
                  <Button className="bg-amber-800 hover:bg-amber-700 text-white font-bold px-6 py-3" data-testid="btn-watch-beautiful-threat">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-zinc-950 border border-amber-900/30 rounded-2xl p-8 mb-16">
          ...
          <div className="w-16 h-0.5 bg-amber-800 mb-6" />
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            {[
              { rating: "CORROBORATED", count: `${CLAIM_COUNT} of ${CLAIM_COUNT} claims`, pct: "100%", bg: "bg-amber-950/40", border: "border-amber-700/30", txt: "text-amber-400" },
            ...
            <div key={claim.num} className="bg-zinc-950 border border-zinc-800 rounded-2xl overflow-hidden">
              <div className="bg-zinc-900 border-b border-zinc-800 px-6 py-4 flex flex-col sm:flex-row sm:items-center gap-3">
                <div className="flex items-center gap-2">
                  <Shield className="h-4 w-4 text-amber-900 shrink-0" />
                  <span className="text-sm font-black text-amber-700 tracking-widest">{claim.num}</span>
                </div>
                ...
                <div className="flex items-center gap-1.5 font-bold text-sm text-amber-400 shrink-0">
                  <CheckCircle className="h-4 w-4" />
                  CORROBORATED
                </div>
              </div>
              <div className="px-6 py-6 space-y-4">
                <blockquote className="border-l-2 border-amber-800 pl-4 text-amber-200/80 italic text-sm leading-relaxed">
                  {claim.quote}
                </blockquote>
                ...
                <div className="bg-amber-950/20 border border-amber-900/20 rounded-lg p-4">
                  <div className="text-amber-700 text-xs font-bold uppercase tracking-wider mb-1">Forensic Alignment</div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 lg:grid-cols-9 gap-2 mb-6">
            {[
              ...
              { title: "Beautiful Threat", score: `${CLAIM_COUNT}/${CLAIM_COUNT}`, color: "text-amber-300", border: "border-amber-600/30" },
            ].map(a => (
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-black/50 border border-zinc-800 rounded-xl p-6">
            <div className="text-center">
              <div className="text-5xl font-black text-amber-400">665/665</div>
