                ...
                <div className="p-5 rounded-lg bg-muted/30 border border-border">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/10">
                      ...
                      <p className="text-sm text-foreground leading-relaxed">
                        The target was clinically killed. Dr McLean died in February 2021 and was revived. The NDIS provider witness "Ben" confirmed "ten unmarked cars with armed highly trained agents" and acknowledged the assassination attempt was "a close call." Tony Ridley (NDIA Manager, ex-SAS, counter-terrorism clearance) stated: <span className="font-bold text-red-500">"YOU WILL BE SACRIFICED."</span> This is not a threat of future harm — it is a declaration of predetermined outcome by a government official with military special operations background and one of three people in Australia with his level of counter-terrorism clearance. The victim was brought to clinical death. This element is not merely satisfied — it was fulfilled.
                      </p>
                    </div>
