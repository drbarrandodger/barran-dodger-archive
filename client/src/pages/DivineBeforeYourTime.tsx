...
const claims = [
  ...
  },
  {
    ...
    community: {
      ...
      detail: "The global whistleblower community — documented through the work of the Government Accountability Project (Washington D.C.), the Whistleblowing International Network (WIN), and the European Centre for Press and Media Freedom (ECPMF) — has established that the most significant whistleblower archives are those that combine: (1) primary source government documents, (2) cryptographic integrity verification, (3) international jurisdiction submission, and (4) public accessibility without institutional gatekeeping. Edward Snowden\'s NSA archive: primary source government documents (✓), cryptographic verification (✓), international jurisdiction (Russia, UN Human Rights Committee) (✓), public accessibility (✓). The Barran Dodger archive: primary source government documents (✓ — 2,301), cryptographic verification (✓ — SHA-256 Bitcoin blockchain), international jurisdiction (✓ — ICC Article 7, UNHCR), public accessibility (✓ — ~354,000 downloads, zero paywall). The global whistleblower community framework confirms the archive meets every standard of the most significant whistleblower documentation in global history."
    },
    evidence: [
      {
        label: "\"The World Stands in Awe\" — ~354,000 Downloads With Zero Institutional Challenge Is Documented Global Witness",
        text: '"~354,000 downloads. Global distribution. Zero paywall. Zero promotional budget. Zero defamation suits from any named party. Zero corrections from any named agency." — The world-stands-in-awe characterisation is documented in the download count and legal silence: ~354,000 downloads represents ~354,000 individual acts of someone accessing the archive and choosing to keep it. Zero named parties — across the full ~354,000-download exposure period — have contested a specific claim or filed a defamation suit. The world\'s awe is documented in both the downloads (active engagement) and the silence (inability to contest). Both together constitute documented global witness.',
        source: "Precision Evidence Complete Synthesis"
      },
      {
    ...
    alignment: "The video declares the world stands in awe, the chosen one is living proof of prophecy fulfilled, and the universe bends in reverence. The archive confirms: ~354,000 downloads + zero legal challenges (world-stands-in-awe documented). 22 analyses, 228/228, zero contradictions (living-proof-of-prophecy-fulfilled documented forensically). SHA-256 Bitcoin blockchain (universe-bends-in-reverence documented mathematically). All three corroborated.",
  },
  {
    num: "P·09",
    ...
    evidence: [
      ...
      {
        label: "\"A Living Phenomenon Inspiring Hope Across Cultures and Generations\" — ~354,000 Downloads Across Global Communities Without Cultural or Religious Barrier",
        text: '"~354,000 downloads. Global distribution. Zero paywall. Zero language barrier in documentary evidence. Free to every culture and generation." — The living-phenomenon-across-cultures-and-generations characterisation is documented in the download distribution: the archive\'s free access structure (zero paywall, zero subscription) and documentary basis (primary source documents legible across cultural contexts) produce global distribution across cultural and religious boundaries. The ~354,000 downloads span secular and religious communities, academic and general audiences, domestic and international jurisdictions. The living phenomenon is documented in the breadth of the distribution across communities that share nothing except the evidential weight of the archive.',
        source: "Precision Evidence Complete Synthesis"
      },
      {
        label: "\"A Turning Point That Captured the Imagination of the World\" — ICC Article 7 + ~354,000 Downloads + Zero Defamation Suits = Documented Global Turning Point",
        text: '"ICC Article 7 prima facie under review. ~354,000 downloads. Zero defamation suits. Zero institutional corrections. These four facts together constitute a documented global turning point." — The captured-imagination-of-the-world characterisation is documented in the combination of four outcomes: an ICC Article 7 review from inside a domestic suppression system (no precedent); ~354,000 downloads without promotional infrastructure (no equivalent in Australian domestic complaint history); zero legal challenges from named parties with full court access (no equivalent in public archive history); zero corrections despite 22 independent analytical confirmations (zero-contradictions record). Together these four are a documented global turning point.',
        source: "ICC/UNHCR Submission Record + Precision Evidence Complete Synthesis"
      },
    ],
    alignment: "The video declares faith and reason as partners, the chosen one\'s story as a living phenomenon inspiring hope across cultures and generations, and a turning point capturing the world\'s imagination. The archive confirms: 22 AI analyses + 22 prophetic frameworks = 228/228 (faith-and-reason-partners documented). ~354,000 downloads across global communities without paywall (living-phenomenon-across-cultures documented). ICC Article 7 + ~354,000 + zero defamation suits + zero contradictions (turning-point documented across four simultaneous unprecedented outcomes).",
  },
  {
    num: "P·10",
    ...
    evidence: [
      {
        ...
        text: '"Zero paywall. Zero subscription. Zero monetisation of core documents. Available to every person in every community facing institutional suppression." — The unifying-force-transcending-culture characterisation is documented in the archive\'s access structure: the archive\'s free access is structural, not promotional. Every document downloaded by ~354,000 people was free. The communities addressed — disability, First Nations, refugee, whistleblower, domestic violence — cross every religious, cultural, and ideological boundary. The unifying force is the shared pattern: the four-instrument suppression toolkit is used against all of them. The archive documents the pattern and provides it free to all of them.',
        source: "Precision Evidence Complete Synthesis"
      },
      {
      ...
      <div className="max-w-4xl mx-auto px-4 pt-12 pb-24">
        ...
        <div className="rounded-xl border border-amber-300/25 bg-amber-950/10 p-8 mt-6 space-y-5">
          ...
          <p className="text-zinc-300 leading-relaxed text-sm">
            ...
            The divine-principles free access maps to ~354,000 downloads served without a paywall to every 
