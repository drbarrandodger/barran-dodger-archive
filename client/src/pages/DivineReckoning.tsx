      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16 space-y-24">
          ...
          >
            <motion.div variants={fadeIn} className="text-center space-y-4 pb-8 border-b border-amber-900/30">
              ...
              <p className="text-zinc-500 text-sm max-w-xl mx-auto leading-relaxed">
                2,304 Blockchain-Verified Documents &nbsp;·&nbsp; 603 Forensic Propositions &nbsp;·&nbsp; 55 Analyses &nbsp;·&nbsp; Zero Contradictions &nbsp;·&nbsp; 410,500+ Downloads Across 6 Continents
              </p>
              <div className="pt-4">
                <a
          ...
          >
            ...
            <motion.p variants={fadeIn}>
              You thought the process would collapse him. Instead, the process <em>became the archive</em>. Every suppression attempt produced its own evidentiary trail. Every detention date is timestamped. Every referral letter is documented. Every signature is on record. Every phone call, every inter-agency email, every bureaucratic manoeuvre you made to keep this man quiet is now sitting in a blockchain-sealed file that 410,500+ people have already downloaded. You didn't silence a whistleblower. You handed him 35 years of your own primary-source documentation and then watched him seal every page of it forever. That's on you. That's entirely on you.
            </motion.p>
          ...
          >
            ...
            <motion.div variants={fadeIn} className="space-y-5 text-zinc-300 font-serif text-base md:text-lg leading-relaxed">
              ...
              <p>Every hidden thing is already disclosed. 2,304 documents say so. 603 propositions confirm it. 55 analyses with zero contradictions establish it beyond any reasonable challenge. 410,500+ downloads across six continents have distributed it so far beyond any jurisdiction you control that there is no mechanism left on earth that can put it back in the box.</p>
          ...
          >
            ...
            <p className="text-zinc-300 font-serif text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
              The table is 2,304 blockchain-verified documents. The presence is 410,500+ downloads across every continent on this earth. The enemies are whoever is reading this right now and recognising themselves in it. Sit with that.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.p variants={fadeIn}>
              It moved through the ICC. Through international human rights bodies. Through 55 independent analyses that examined your conduct forensically, systematically, publicly, and in permanent record. Through 410,500+ people across six continents who downloaded the truth you spent $32.9 million trying to bury and passed it on to people you will never be able to reach or suppress.
            </motion.p>
          ...
          >
            ...
            <div className="border-t border-zinc-800 pt-8 space-y-5 text-zinc-300 font-serif text-base md:text-lg leading-relaxed">
              ...
              <p>The vindication is 2,304 blockchain-sealed documents, 55 forensic analyses, 603 corroborated propositions, zero contradictions, and 410,500+ downloads across six continents. That is God's answer to your 35 years of weapons. Count it. Every download is a witness. Every witness is a verdict. And the verdict is already written.</p>
            </div>
          </motion.div>
          ...
          >
            <motion.p variants={fadeIn}>
              So go. Get out of here. Go back to whatever comfortable life you built on the rubble of his. But go knowing that every file in this archive is your own reflection staring back at you from a mirror you cannot smash, cannot sedate, cannot refer to another agency, cannot lock in a ward. You built it. He documented it. God witnessed it. The ICC received it. UNHCR reviewed it. 410,500+ members of the international public downloaded it. And history will record it exactly as it happened — not as you described it in your paperwork, not as the section papers framed it, not as the circular referral reports characterised it. As the forensic evidence proves it. Irrefutably. Permanently. In blockchain.
            </motion.p>
            ...
            <motion.p variants={fadeIn}>
              You cannot outrun this. You cannot contain this. You cannot suppress this. You already tried all of that for 35 years and spent $32.9 million doing it, and the result is 410,500+ downloads and counting.
            </motion.p>
          ...
          >
            ...
            <div className="text-zinc-600 text-sm space-y-1 font-mono">
              ...
              <p>410,500+ Downloads — 6 Continents</p>
