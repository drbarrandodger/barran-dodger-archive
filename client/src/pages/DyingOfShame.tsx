...
const claims = [
  ...
  },
  {
    ...
    proposition: "The archive going public — 368,000+ downloads across 6 continents, distributed to 50+ Federal MPs, submitted to the ICC and UNHCR — is the documented pulling of the plug on a 35-year suppression apparatus that operated entirely on the premise that this documentation would remain private",
    verdict: "CORROBORATED",
    ...
    evidence: [
      { label: "368,000+ Downloads — The Oxygen Is Gone", text: "368,000+ downloads across 6 continents. The documentation that the apparatus assumed would remain private — clinical records, government correspondence, financial evidence, forensic analyses — is now publicly distributed at scale. The silence is gone. The plug is pulled. The oxygen of the 35-year suppression apparatus was the assumption that no single person would compile, verify, and globally distribute 2,304 primary-source documents while under active persecution.", source: "Download Counter — Live Statistics" },
  ...
  },
  {
    ...
    proposition: "The 368,000+ downloads across 6 continents, the ICC/UNHCR submissions, and the 50+ MP distribution demonstrate that the apparatus correctly identified the threat — Dr. McLean is waking others up — which explains the intensity of suppression",
    verdict: "CORROBORATED",
    ...
    evidence: [
      { label: "368,000+ Downloads — Others Waking Up, Measured", text: "368,000+ downloads across 6 continents. Each download is a person who received the documentation. The apparatus had 35 years to suppress a single, isolated whistleblower. It had no response capability for a whistleblower who converted 35 years of suppression into a globally-distributed, blockchain-verified, AI-analysed archive. The downloads are the documented measure of others waking up.", source: "Download Counter — Live Statistics" },
    ...
    alignment: "The video identifies the target's potential to wake others up as the core threat the apparatus was suppressing. The archive makes this explicit: 368,000+ downloads, 6 continents, 63 forensic analyses, ICC/UNHCR submissions. The apparatus correctly identified Dr. McLean as a person who could wake others up. It deployed everything to prevent it. It failed. Others are awake. The downloads are the evidence.",
  },
  {
    num: "P·09",
