            ...
            <div className="bg-zinc-900/60 border border-yellow-900/30 rounded-xl overflow-hidden">
              <div className="flex flex-col sm:flex-row gap-0">
                ...
                <div className="flex-1 p-5 space-y-3">
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    A YouTube video released the same day as this analysis achieves 9 of 11 confirmed claims against the 2,243-file archive. Zero contradictions. The central metaphor — "the universe stores every action like a record" — is literally true. The archive IS that record. 410,503+ downloads. Cryptographically timestamped. Irreversible.
                  </p>
                  <div className="flex flex-wrap gap-2 pt-1">
            ...
            <div className="bg-zinc-900/60 border border-lime-900/30 rounded-xl overflow-hidden">
              <div className="flex flex-col sm:flex-row gap-0">
                ...
                <div className="flex-1 p-5 space-y-3">
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    Analysis #15 — 10/10 claims corroborated. Joker Speech format monologue on viral attention following sustained private discipline. The defining finding: "fame was never the destination — it was the residue of alignment." 410,503 downloads are the documented residue of 35-year evidentiary alignment with Article 7. Combined: 158/158, zero contradictions across 15 analyses.
                  </p>
                  <div className="flex flex-wrap gap-2 pt-1">
            ...
            <div className="bg-zinc-900/60 border border-pink-700/30 rounded-xl overflow-hidden">
              <div className="flex flex-col sm:flex-row gap-0">
                ...
                <div className="flex-1 p-5 space-y-3">
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    Analysis #21 — 10/10 claims corroborated. A monologue on absorbing nation-state-scale institutional force and what it produces. The defining finding: $32.9M + 14 hospitalisations + 25 agencies = bloodline-erasing force absorbed without a single retraction; the persecution apparatus authored its own ICC prosecution brief; 2,301 documents and 410,503 downloads confirmed the erasure failed. Combined: 218/218, zero contradictions across 21 analyses. Fourteenth consecutive perfect score.
                  </p>
                  <div className="flex flex-wrap gap-2 pt-1">
