          ...
          <div className="px-5 py-4 space-y-3 font-sans text-xs">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <p className="text-white/80 text-[11px] leading-tight">Forensic Corroboration Analysis #69 — The 3AM Briefing</p>
              </div>
              <div>
