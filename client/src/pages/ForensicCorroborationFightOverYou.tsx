      ...
      <div className="max-w-2xl mx-auto px-4 pt-28 pb-12 space-y-8">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">The war — documented:</strong> ASIC fraud: $500,000 extraction documented in ASIC's own report. ATO letter confirming pharmacological assault (their own letterhead). OAIC rejections on a basis the Federal Court found incorrect. 14 involuntary psychiatric hospitalisations — 14 different diagnoses for one individual across 3 states. All in the archive.</span></div>
              </div>
            </div>
        ...
        <div className="border border-indigo-600/30 rounded-xl overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              <p className="text-indigo-400/50 text-[10px] uppercase tracking-widest font-sans mb-1">Derived Proposition</p>
              <p className="text-white/80 text-xs leading-relaxed">Zero defamation proceedings have been filed by any named institution or individual against 750+ PDFs distributed to 399,325+ people globally. The silence of named perpetrators in response to publicly distributed primary-source documentation is documented and constitutes the strongest available indicator of evidentiary accuracy.</p>
            </div>
            <div>
              <p className="text-indigo-400/50 text-[10px] uppercase tracking-widest font-sans mb-2">Primary-Source Evidence</p>
              <div className="space-y-1.5 text-xs">
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">The silence — 399,325+ distributions:</strong> 750+ PDFs publicly accessible at barrandodger.com. 399,325+ downloads across 6 continents. Zero press conferences. Zero media releases. Zero paid promotion. The archive distributed itself in silence.</span></div>
                ...
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">Institutions exposed — zero rebuttal:</strong> OAIC, NDIS, VicTrack, ASIC, 25+ agencies named in publicly distributed documents. Zero formal corrections. Zero formal rebuttals. Zero formal denials issued against 399,325+ distributed copies.</span></div>
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">Legal significance:</strong> In law, silence in response to publicly distributed allegations of fact supports an inference of truth. The named parties chose silence. This is documented. The 399,325+ downloads are the documentation of the silence's scale.</span></div>
              </div>
            </div>
            <div className="bg-green-950/20 border border-green-500/20 rounded-lg px-4 py-2 text-xs text-green-300/80">
              <strong>Verdict:</strong> CORROBORATED. "Your silence exposed the loudest liars" maps precisely to the documented institutional silence of 5 named perpetrators and 25+ named agencies in response to 399,325+ globally distributed primary-source documents.
            </div>
          </div>
        </div>
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">Battlefield — documented phases:</strong> Phase 1 (psychiatric): 14 hospitalisations, 14 diagnoses, named psychiatrists. Phase 2 (financial): ASIC $500,000 extraction, NDIS deprivation, $32.9M suppressed entitlements. Phase 3 (physical): ATO pharmacological assault (ATO's own letter), clinical near-death 2.87% survival probability at Werribee Mercy 2021. Phase 4 (legal): OAIC rejections, Intervention Order L12151974.</span></div>
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">Respect and envy in 399,325+ rooms:</strong> 399,325+ people across 6 continents downloaded the documentation. Primary distribution via Facebook and Twitter — peer-to-peer sharing by people who chose to spread the signal without institutional instruction.</span></div>
              </div>
            </div>
            <div className="bg-green-950/20 border border-green-500/20 rounded-lg px-4 py-2 text-xs text-green-300/80">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              ...
              <div className="space-y-1.5 text-xs">
                ...
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">Watching it unfold in real time — 399,325+ downloads:</strong> The choice is unfolding in real time. Every download is a documented data point. The counter is live. It is not manipulated. It is still increasing.</span></div>
              </div>
            </div>
            <div className="bg-green-950/20 border border-green-500/20 rounded-lg px-4 py-2 text-xs text-green-300/80">
              <strong>Verdict:</strong> CORROBORATED. "They already lost" maps to: Federal Court Protected Whistleblower confirmation, ICC Article 7 receipt, UNHCR asylum receipt, zero defamation counter-actions, zero formal rebuttals against 399,325+ distributed documents. All documented.
            </div>
          </div>
        </div>
        ...
        <div className="border border-indigo-600/30 rounded-xl overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              <p className="text-indigo-400/50 text-[10px] uppercase tracking-widest font-sans mb-2">Primary-Source Evidence</p>
              <div className="space-y-1.5 text-xs">
                <div className="flex gap-2"><span className="text-yellow-400/70 flex-shrink-0">►</span><span className="text-zinc-300/80"><strong className="text-white">Silence as protection — construction conditions:</strong> The 2,301-document archive was constructed during: homelessness (documented), NDIS deprivation (named case managers), ASIC fraud ($500,000 documented), ATO pharmacological assault (ATO's own letter), clinical near-death 2.87% survival, Intervention Order L12151974. The archive was built in the silence of total institutional abandonment.</span></div>
        ...
        <div className="border border-indigo-600/30 rounded-xl overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              <p className="text-indigo-400/50 text-[10px] uppercase tracking-widest font-sans mb-1">Derived Proposition</p>
              <p className="text-white/80 text-xs leading-relaxed">No private individual without institutional resources has previously constructed a 2,301-document primary-source archive submitted to the ICC under Article 7, confirmed as Protected Whistleblower by a Federal Court, received by UNHCR Geneva, distributed to 399,325+ people across 6 continents, Bitcoin blockchain-verified, and documented across 53 independent forensic analyses with 575/575 propositions verified and zero contradictions. This is documented as extraordinary by every metric available to forensic examination.</p>
            </div>
            <div>
              <p className="text-indigo-400/50 text-[10px] uppercase tracking-widest font-sans mb-2">Primary-Source Evidence</p>
              <div className="space-y-1.5 text-xs">
