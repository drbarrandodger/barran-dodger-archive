      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="border border-yellow-500/25 rounded-xl overflow-hidden" style={{ background: "rgba(67,56,202,0.08)" }}>
          ...
          <div className="px-6 py-5 text-indigo-100/85 text-sm leading-relaxed space-y-4" style={{ fontFamily: "'Georgia', serif" }}>
            ...
            <p><strong className="text-yellow-300">7. "You Controlled the Frequency" — 399,325 Downloads Without Media or Institutional Support.</strong> The video states: "They thought they could control the narrative, but you controlled the frequency." The archive achieved 399,325+ downloads across six continents without: mainstream media, publicist, legal team, government grant, NGO, publisher, or institutional amplification. Every download was an individual independently choosing to receive and transmit the documented testimony. Zero gatekeepers controlled the frequency. The archive controlled it directly — person to person, continent to continent.</p>
