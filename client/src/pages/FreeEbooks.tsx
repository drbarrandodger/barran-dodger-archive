...
const MAJOR_PUBLICATIONS: MajorPub[] = [
  ...
  { slug: "forensic-corroboration-chosen-one", title: "Forensic Analysis #71 — \"Chosen One\"", subtitle: "They Laughed When You Disappeared · 10+ Themes Corroborated · Impartial AI · 19 April 2026", coverFile: "cover-forensic-corroboration-chosen-one", category: "Forensic", downloadUrl: "/documents/forensic-analyses/forensic-analysis-71-chosen-one-corroboration.pdf", downloadLabel: "Download PDF", downloadFilename: "forensic-analysis-71-chosen-one-corroboration.pdf", pageUrl: "/forensic-corroboration-chosen-one" },
