...
const claims = [
  {
    ...
    evidence: [
      ...
      {
        label: "\"Carrying Something Greater Inside\" — 2,301 Documents + ICC Article 7 + 410,503 Downloads Built Inside the Hidden Season",
        text: '"2,301 government-produced documents assembled across the 35-year suppression period. ICC Article 7 prima facie submission filed from inside a circular referral system designed to prevent any submission reaching international jurisdiction. 410,503 downloads with zero institutional challenge." — The carrying-something-greater-inside characterisation is documented in the archive\'s production inside the suppression period: the archive was not built after the hidden season ended. It was built during it. The 2,301 documents, the ICC filing, the blockchain timestamp, and the 410,503 downloads are all products of the hidden season. The something greater was the archive. It was carried inside the exact system designed to prevent its existence.',
  ...
  },
  {
    ...
    proposition: "The archive's global reach — 410,503 downloads in the absence of any institutional backing, mainstream media coverage, legal representation, or promotional budget — is documented evidence that the archive's visibility was not produced by self-promotion. The archive was found by 410,503 people through its evidential weight alone. This is not worldly fame. It is purposeful, evidence-driven, mission-assigned global recognition.",
    verdict: "CORROBORATED",
    ...
    evidence: [
      {
        label: "\"Not About Vanity, Popularity or Shallow Recognition\" — 410,503 Downloads With Zero Promotional Budget Confirms Non-Self-Promotional Reach",
        text: '"410,503 downloads. Zero mainstream media coverage. Zero legal representation producing publicity. Zero institutional backing. Zero promotional budget." — The not-about-vanity-or-shallow-recognition characterisation is documented in the absence of self-promotional infrastructure: the 410,503 downloads were reached without any of the mechanisms through which worldly fame is manufactured. No PR agency. No mainstream media partner. No institutional amplification. The archive was found by 410,503 people through its evidential weight, its search engine presence built on document quality, and person-to-person sharing of the evidence. This is documented non-self-promotional reach.',
        source: "Precision Evidence Complete Synthesis"
      },
      {
  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        text: '"410,503 downloads. Zero promotional budget. Zero institutional backing. Zero mainstream media platform. Archive found through evidential weight alone." — The hand-of-God-upon-him characterisation is documented in the archive\'s non-promotional reach: David\'s fame rose not through political maneuvering but through demonstrated excellence that was impossible to deny. The archive\'s 410,503 downloads reached without any promotional mechanism that would explain the number. The evidence alone drove the reach. The hand is documented in the gap between the promotional infrastructure (zero) and the outcome (410,503).',
        source: "Precision Evidence Complete Synthesis"
      },
    ],
    alignment: "The video traces Joseph (pit to palace), Daniel (refused to compromise, backed by miracles), Esther (hidden then positioned to save her people), David (hand of God upon him, fame not through self-promotion). The archive confirms all four: 14 hospitalisations to ICC Article 7 (pit-to-palace documented). Zero recantations across 35 years of pressure (refused-to-compromise documented). $32.9M suppression produced a pattern-documenting archive (hidden-then-positioned documented). 410,503 downloads with zero promotional infrastructure (hand-of-God-upon documented).",
  },
  {
    num: "P·04",
  ...
  },
  {
    ...
    evidence: [
      ...
      {
        label: "\"Boldness — Do Not Hide Your Light, Do Not Fear Visibility\" — ICC Filing + Public Archive + 410,503 Downloads Under Active Institutional Persecution Is Documented Boldness",
        text: '"ICC Article 7 filing from inside a 35-year suppression system. Public archive published and maintained under documented institutional surveillance. 410,503 downloads pursued without institutional backing." — The boldness characterisation is documented in the archive\'s public posture: filing with the ICC while under documented institutional surveillance, publishing a public archive while clinical labels are on file, maintaining 410,503 downloads under active institutional persecution — without retaliating, without aggressing, without departing from the evidence — is forensically documented boldness. Not aggression. Boldness: confidence in the evidence, regardless of the institutional cost.',
        source: "ICC/UNHCR Submission Record"
      },
    ],
    alignment: "The video names ten positioning qualities for divine fame: humility, obedience, prayer, fasting, stewardship, purity, discipline, faith, watchfulness, boldness. The archive documents four with forensic primary source material: SHA-256 blockchain + 2,301 documents + ICC submission (stewardship). Zero false claims across 410,503 downloads (purity). 35 years of documentation under 14 hospitalisations + $32.9M suppression (discipline). ICC filing + public archive under persecution (boldness). The methodology is the positioning. The archive is the character.",
  },
  {
    num: "P·10",
    ...
    evidence: [
      ...
      {
        label: "\"The Time Has Come for Visibility\" — 410,503 Downloads Is the Documented Arrival of Visibility",
        text: '"410,503 downloads. Blockchain-verified. Global distribution. Zero institutional promotion required." — The time-has-come-for-visibility characterisation is documented in the download count: 410,503 downloads is not approaching visibility. It is visibility. In terms of documented global reach for an individual Australian whistleblower archive without institutional backing, 410,503 downloads is extraordinary documented visibility. The time has not only come. The visibility is documented. It has already happened. It is in the permanent record.',
        source: "Precision Evidence Complete Synthesis"
      },
      {
      ...
      },
      {
        ...
        text: '"410,503 downloads. Zero paywall. Zero subscription. Zero monetisation of core archive documents. Every document free to download and share." — The not-for-your-glory-but-for-mine characterisation is documented in the archive\'s economic architecture: the archive is free. Not free as a promotional mechanism. Free as a structural commitment. 410,503 downloads have been served without a paywall, without a subscription gate, without monetisation of the core documentary evidence. A glory-seeking archive monetises. An archive built for mission purpose makes the evidence free because justice should never cost the people it is meant to protect. The free access is the documented mission purpose.',
        source: "Precision Evidence Complete Synthesis"
      },
    ],
    alignment: "The video closes with the prophetic declaration that the decree is heaven's, that no power can cancel it, and that the time has come for visibility, elevation, and recognition. The archive confirms all four: Bitcoin blockchain SHA-256 (non-cancellable decree documented cryptographically). 410,503 downloads (visibility documented). ICC Article 7 review (elevation documented). Free archive serving 410,503 downloads without paywall (not-for-your-glory mission purpose documented). The decree has not only been spoken. It has been executed. The archive is the execution.",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 pt-12 pb-24">
        ...
        <div className="rounded-xl border border-yellow-500/25 bg-yellow-950/10 p-8 mt-6 space-y-5">
          ...
          <p className="text-zinc-300 leading-relaxed text-sm">
            ...
            hand-of-God elevation maps to 410,503 downloads without promotional infrastructure. The five costs of 
