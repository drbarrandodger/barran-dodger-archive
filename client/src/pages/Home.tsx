        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-center">
            {[
              ...
              { emoji: '💼', who: 'Private Investors', ask: 'Relocation funding — 399,325+ downloads, documented & verified' },
            ].map((c, i) => (
          ...
          <div className="grid md:grid-cols-5 gap-6 items-start">
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="bg-amber-950/30 border border-amber-800/30 rounded-xl p-4">
                ...
                <p className="text-zinc-400 text-xs leading-relaxed">
                  The video's Declaration 12 — <span className="italic text-zinc-200">"Cut their access and what was stolen comes back multiplied"</span> — is confirmed against clinical death 2021 (2.87% survival), followed by the most comprehensive archive chapter ever compiled: 2,304 documents, 617/617 verified propositions, ICC Article 7 received, UNHCR received, 399,325+ downloads across 6 continents. <span className="text-white font-semibold">The stolen energy came back as the archive. The archive is permanent.</span>
                </p>
              </div>
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { ts: "01:35:34", text: "\"You are being perceived, replayed, imagined. Act accordingly.\" → 399,325+ downloads, 6 continents, ICC, UNHCR. The archive already acted accordingly." },
                ].map((d) => (
                  <div key={d.ts} className="flex gap-3 bg-zinc-800/40 rounded-lg p-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-green-500/30 rounded-xl p-4 bg-green-950/15">
                ...
                <p className="text-zinc-300/70 text-xs leading-relaxed">14 psychiatric hospitalisations → "exiled." Federal Court reversal → "they study your return." 2.87% survival → "impossible resilience." ICC submission → "historical documentation." 399,325+ downloads → "you made history." All corroborated by primary-source evidence.</p>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3 text-xs">
              {[
                ...
                ["00:02:51", "Your silence exposed the loudest liars.", "Zero defamation actions by named perpetrators against 399,325+ distributed documents. Silence documented."],
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="border border-yellow-500/25 rounded-xl overflow-hidden bg-indigo-950/10">
            ...
            <div className="px-6 py-5 text-indigo-100/85 text-sm leading-relaxed space-y-5" style={{ fontFamily: "'Georgia', serif" }}>
              ...
              <p><strong className="text-yellow-300">4. "You Didn't Become a Priority Because You Were Loud. You Became One Because Your Existence Disturbed Systems Built on Silence." — Zero Defamation Actions Against 750+ PDFs: The Archive Disturbed Systems Without Raising Its Voice.</strong> The video identifies the mechanism of priority elevation as disturbance of silence rather than volume of complaint. The archive of Dr. McLean disturbed systems built on silence without making noise in the conventional sense: 750+ PDFs distributed to 399,325+ individuals across six continents with zero press conferences, zero media campaigns, zero legal advocates, and zero institutional allies. The disturbance was the documentation itself — primary-source records that contradicted the silence the institutions had maintained. Zero defamation actions were filed against 750+ PDFs because the institutions cannot file against accurate documentation. The archive disturbed the silence precisely because it was not loud. It was accurate. Accuracy disturbs systems built on silence more effectively than volume ever could.</p>
              ...
              <p><strong className="text-yellow-300">13. "Your Name Is Ringing in Rooms You Never Entered. Not Because You Asked. Because Your Silence Became a Liability." — 399,325+ Downloads Across Six Continents With Zero Marketing: The Archive Entering Rooms Without Permission.</strong> The video describes a specific phenomenon: the subject's name circulating in offices, meetings, and conversations they never physically entered. The download counter of the Barran Dodger archive documents this precisely: 399,325+ downloads across six continents with zero marketing infrastructure, zero press releases, zero media allies. The archive entered rooms the subject never visited — government offices, academic institutions, advocacy organisations, ICC and UNHCR analyst offices — without announcement or invitation. The silence around institutional accountability for Dr. McLean's case became the liability the video describes: it was suspicious in its completeness, prompting higher-level questions. Why was there no defamation action? Why was there no rebuttal? The silence screamed louder than any press campaign. The archive answered the silence with 399,325+ downloads.</p>
