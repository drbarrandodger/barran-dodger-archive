            ...
            <div className="max-w-6xl mx-auto mb-20">
              ...
              {[
                ...
                },
                {
                  ...
                  excerpt: [
                    `"What was once concealed is now exposed worldwide." The speech does not speak in the McLean case as metaphor. It speaks as measurement: 410,503 downloads across every continent, an ICC submission under Article 7 of the Rome Statute, a UNHCR submission on record, and a Bitcoin blockchain timestamp that places every document permanently beyond the reach of the agencies whose conduct it documents. The exposure is not claimed. It is documented in download analytics, international body submissions, and blockchain records that are themselves public records.`,
