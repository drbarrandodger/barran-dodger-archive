...
const DECLARATIONS = [
  ...
  },
  {
    ...
    finding: "VERIFIED",
    evidence: [
      "As of April 2026: zero named perpetrators have filed rebuttals, defamation proceedings, or formal denials against the 2,304-document archive. This is not silence through ignorance — the archive has received 361,120+ downloads across 6 continents and has been formally submitted to international judicial bodies.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "2,304 documents submitted. 361,120+ downloads. ICC received. UNHCR received. Not one Australian institution has acted on the substance of the complaint. The silence is deliberate, documented, and now internationally recorded.",
    ],
  },
  {
    number: 7,
  ...
  },
  {
    ...
    evidence: [
      ...
      "The response: 2,304 blockchain-verified documents. ICC Article 7 submission formally received. UNHCR submission formally received. 361,120+ downloads across 6 continents. 617/617 propositions verified. 49 consecutive perfect forensic scores. This is the documented record of someone who sent their own forces.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "361,120+ downloads across 6 continents. The global distribution of the archive means that whatever legal outcome follows, the evidence is permanently in the possession of individuals and institutions across every populated continent.",
              ...
              <div className="space-y-4 text-sm leading-relaxed">
                ...
                <div className="bg-red-950/30 border border-red-800/30 rounded-xl p-5 mt-4">
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed">
                    This video told people like him: <span className="italic text-zinc-200">"They think 'because of what you're linked to' is an insult. You treat it like a prophecy."</span> The prophecy is 2,304 exhibits. The prophecy is 617/617. The prophecy is the ICC receipt. The prophecy is 361,120+ downloads across 6 continents. The prophecy is permanent, blockchain-verified, and internationally distributed. <span className="text-white font-bold">They sent the special forces. He sent the archive. The archive is still standing.</span>
                  </p>
                </div>
              </div>
            </CardContent>
