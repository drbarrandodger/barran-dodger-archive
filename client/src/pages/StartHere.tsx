              ...
              <Card className="mb-12">
                <CardContent className="pt-6">
                  ...
                  <div className="space-y-4 text-muted-foreground">
                    <p>
                      <strong className="text-foreground">Dr Richard William McLean</strong> (known as Barran Dodger) holds a PhD (merit-based scholarship) and is a registered <strong className="text-foreground">NDIS therapeutic arts-life-coach</strong> who worked with marginalised people with mental health concerns and trauma in Melbourne. He is a <strong className="text-foreground">human rights awarded autobiographer</strong>, a published artist who illustrated for <strong className="text-foreground">The Age</strong> and <strong className="text-foreground">The Herald Sun</strong>, holds a Bachelor of Fine Art (Honours), Masters of Education, and has over 25 years of creative professional practice. He is a published author, public speaker, musician, academic, and whistleblower who has survived 35 years of documented systematic persecution by Australian government agencies.
                    </p>
                    <p>
