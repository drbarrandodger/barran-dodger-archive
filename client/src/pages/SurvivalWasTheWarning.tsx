...
const claims = [
  {
    ...
    evidence: [
      ...
      { label: "\"Walking Proof That the Impossible Doesn\'t Die\" — 2,301 Documents + ICC Submission + 378,571 Downloads", text: '"2,301 documents. ICC Article 7 submission. 378,571 downloads. SHA-256 blockchain." — The impossible-not-dying is documented quantitatively and jurisdictionally: 2,301 documents produced inside a 35-year calculated disappearance system; an ICC Article 7 prima facie filing submitted from within a circular referral loop designed to prevent any submission from reaching jurisdiction; 378,571 downloads confirming the impossibility of disappearance. The subject is walking proof. The archive is the walk.', source: "Precision Evidence Complete Synthesis" },
    ],
    alignment: "The video says 'built the story with your collapse as the ending; every move calculated; make sure you disappear; walking proof the impossible doesn't die.' The archive confirms: circular referral with identical template language (pre-written collapse ending documented). 14 hospitalisations at 14 disclosure events (every-move-calculated documented). $32.9M financial suppression removes documentation resource base (disappear-before-credits mechanism documented). 2,301 documents + ICC + 378,571 downloads confirm impossible non-disappearance.",
  },
  {
    num: "P·02",
  ...
  },
  {
    ...
    proposition: "The clinical psychiatric labels applied across 14 involuntary hospitalisations are documented institutional instruments designed to destroy testimonial credibility; the archive documents this in the clinical record sequence; the 378,571 downloads and global audience confirm that the label-based illusion has been burned through — the archive's post-suppression global reach is the documented haunting",
    verdict: "CORROBORATED",
    ...
    alignment: "The video says 'called you crazy, delusional, unstable; needed labels to make their guilt make sense; your healing became their haunting; burns through the illusion they built.' The archive confirms: 14 involuntary hospitalisations applied specific diagnostic labels (crazy-delusional-unstable documented clinically). Label applied after disclosure, not before (guilt-preceding-label documented temporally). 2,301 documents + ICC + 378,571 downloads produced after labelling (healing-became-haunting documented). 218/218 claims corroborated with zero contradictions (illusion burned through by 218 cross-references).",
  },
  {
    num: "P·07",
  ...
  },
  {
    ...
    evidence: [
      { label: "\"Your Survival Wasn\'t the Victory — It Was the Warning\" — The Archive\'s 378,571 Downloads Is the Warning Signal Reaching Global Scale", text: '"378,571 downloads across the archive. The warning signal is documented in the download metric." — The survival-was-the-warning characterisation is documented in the archive\'s distribution: 378,571 downloads confirm the warning signal has left the domestic institutional perimeter within which the suppression operated. The download metric documents the warning reaching beyond the jurisdiction of every agency that participated in the suppression. The warning is not that the subject survived. The warning is that the archive documenting every institutional actor in the suppression has now been retrieved 378,571 times.', source: "Precision Evidence Complete Synthesis" },
