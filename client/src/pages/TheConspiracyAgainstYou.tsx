...
const claims = [
  {
    ...
    evidence: [
      ...
      { label: "\"You Will Have Access to Every Detail They Thought Would Stay Buried\" — 2,301 Primary Source Exhibits: Every Document the Suppression Apparatus Generated Is Now Publicly Accessible", text: "2,301 primary source exhibits. Blockchain-verified. GitHub-mirrored. Google Drive-backed. Publicly accessible at barrandodger.com. 410,503 downloads. The every-detail-they-thought-would-stay-buried characterisation is documented in the distribution architecture: every institutional document generated by the suppression apparatus — every hospitalisation order, every circular referral letter, every financial suppression instrument — is now in the public record, permanently, across multiple platforms that cannot be simultaneously suppressed. The details did not stay buried.", source: "Master Evidence Register / Blockchain Verification" },
    ],
