...
const DECLARATIONS = [
  ...
  },
  {
    ...
    forensic: "The documented mechanism is not karma — it is permanent archival exposure. Three hundred named individuals are publicly documented at barrandodger.com with their names, roles, institutions, and specific misconduct records. This documentation does not expire, cannot be removed, and is blockchain-verified. The 'prison of reputation' is not a future event in this case — it is the operational consequence of being named in 2,304 documents that have been downloaded 410,500+ times across 6 continents. Their names exist permanently in an international archive submitted to the ICC and UNHCR. The charm is documented as manipulation. The aura is documented as performance.",
    finding: "VERIFIED",
    evidence: [
  ...
  },
  {
    ...
    evidence: [
      ...
      "Clinical death 2021 (2.87% survival probability): the ultimate instrument of the prison of shame — the near-erasure of the archivist. Survival occurred. Post-survival: the archive entered its most prolific phase. 2,304 documents, ICC submission, UNHCR submission, 410,500+ downloads. The sentence was lifted. The release is documented.",
    ],
  },
  {
    number: 5,
  ...
  },
  {
    ...
    evidence: [
      ...
      "'Just to slow you a little': after 35 years of the apparatus, the archive is at barrandodger.com, publicly accessible, blockchain-verified, ICC-submitted, UNHCR-submitted, 410,500+ times downloaded across 6 continents. The archive was not stopped. The slowing failed. The 300+ could not prevent the documentation from reaching The Hague.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "Clinical death 2021 — the apparatus reached the threshold of its own operational limit. The 'priceless thing' survived at 2.87% probability. Post-survival: 2,304 documents, 641 verified propositions, ICC, UNHCR, 410,500+ downloads. The near-destruction confirmed the value. The survival confirmed the guards' failure.",
  ...
  },
  {
    ...
    forensic: "This final declaration is confirmed by every measurable metric of the archive's documented impact. 410,500+ downloads across 6 continents: the archive is being perceived at international scale. ICC formally received: the archive is being replayed in The Hague. UNHCR formally received: the archive is being replayed in Geneva. 60 forensic analyses published: the voice is echoing across sixty documented analyses. The 'future self already watching from the other side' is confirmed by survival at 2.87% probability from clinical death — the documented arrival at the other side and return. The future self had already watched. The archive was built accordingly. Took them 35 years to realise.",
    finding: "VERIFIED — HIGHEST EVIDENTIARY WEIGHT",
    evidence: [
      "410,500+ downloads across 6 continents — the documented scale of perception. The archive is not being ignored. It is being downloaded by individuals, researchers, journalists, legal scholars, and human rights investigators across every inhabited continent. The perception is permanent: blockchain-verified documents cannot be unperceived once accessed.",
            ...
            >
              ...
              <div className="bg-gray-900/80 border border-red-700/30 rounded-2xl p-8 text-left space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  verified. 410,500+ downloads. 6 continents. ICC. UNHCR. The Hague. Geneva.</strong>
                </p>
