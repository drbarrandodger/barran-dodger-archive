...
const DECLARATIONS = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "The 'silence' produced 2,304 blockchain-verified documents, ICC submission, UNHCR submission, 492,544 downloads across 6 continents. That is not weakness. That is the most consequential deployment of documented evidence in Australian whistleblower history.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "ICC Article 7 submission formally received. UNHCR formally received. 492,544 downloads across 6 continents. These arrived not from aggression but from documentation. The steady movement produced international submission. The outcome was known before the battle because the evidence was primary-source.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "Post-clinical death: the archive entered its most prolific phase. 2,304 documents assembled. 60 forensic analyses produced. ICC submitted. UNHCR submitted. 492,544 downloads achieved. The 'consequence forming silently' after clinical death was the multiplication of the archive. The destruction attempt produced the expansion.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "492,544 downloads across 6 continents — the archive reaching rooms, countries, and jurisdictions that no single person could physically access. The 'future so luminous' arrived as global distribution of documentation. Their hostility, documented in the archive, made the distribution more significant.",
  ...
  },
  {
    ...
    evidence: [
      ...
      "492,544 downloads across 6 continents: the measurable footprint of the tectonic shift. Antarctica, Africa, Asia, Europe, North America, South America — the archive reached all inhabited continents. The shift was not contained to Australia. It was global. Documented and downloadable.",
