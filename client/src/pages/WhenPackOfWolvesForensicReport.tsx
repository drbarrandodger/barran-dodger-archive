...
const CLAIMS: Claim[] = [
  ...
  },
  {
    ...
    archiveAnalysis:
      "The archive documents zero retaliation across 35 years. Tony Ridley sent a death threat — McLean documented it. Stefan Iasonidis conducted co-tenancy intelligence extraction — McLean documented it. Sukhi Tear embezzled $50,000 — McLean documented it. The entire institutional apparatus coordinated against him — McLean documented it. The response was never counter-attack. It was documentation. The archive then handed that documentation to the ICC — exactly the court the video describes, 'far more powerful than human hands.' The ICC is the documented outcome of the silence strategy. The UNHCR Geneva filing is the documented outcome of the silence strategy. 361,000+ downloads across 6 continents is the documented outcome of the silence strategy.",
    archiveEvidence:
      "Zero retaliation documented across 35 years. ICC Article 7 formal receipt — the court far more powerful than human hands. UNHCR Geneva filed. 361,120+ downloads. Silence handed the case to international jurisdiction.",
    verdict: "CORROBORATED",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    archiveAnalysis:
      "Stefan Iasonidis's 2011 co-tenancy at 10 Raleigh St Footscray is the archive's most precise documented example. The intelligence extraction operation was designed as an invisible infiltration — a deep cover mechanism that no external observer could detect. The co-tenancy is now an ICC exhibit. The $500,000 ASIC-documented extraction is now a primary-source record. The Intervention Order L12151974 and ATO drugging letter connected to this period are now international evidence. What Iasonidis believed was the darkness of invisible intelligence work is now the most precisely documented section of the McLean archive — submitted to The Hague, available at barrandodger.com, downloaded 361,000+ times. Their secret has become their sentence.",
    archiveEvidence:
      "Stefan Iasonidis: 10 Raleigh St Footscray 2011 co-tenancy = ICC exhibit. ASIC: $500,000 extraction documented. ATO drugging letter. Intervention Order L12151974. What was secret is now downloaded 361,120+ times across 6 continents.",
    verdict: "CORROBORATED",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    archiveAnalysis:
      "The archive documents the intended endpoint with clinical precision: 2021 near-death event at 2.87% documented survival probability. This was the network's operational terminal point. The post-2021 record is the documented refutation of that endpoint: the most prolific documentation phase in the 35-year record, the ICC submission framework, the UNHCR Geneva filing, 361,000+ downloads, 53 forensic analyses, 575/575 verified propositions, 47 consecutive perfect scores. The video's proposition — every step forward is a direct contradiction to the planned outcome — is recorded numerically at barrandodger.com. Every download is a measured contradiction. Every analysis is a measured contradiction. Every perfect score is a measured contradiction. The survival is not metaphorical. It is documented at 361,120 download events across 6 continents.",
    archiveEvidence:
      "2021 clinical death at 2.87% survival probability — documented intended endpoint. Post-2021: most prolific archive phase. 361,120+ downloads. 53 analyses. 575/575 verified. 47 consecutive perfect scores. The rise is documented and measured.",
    verdict: "CORROBORATED",
  },
  {
    id: 11,
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeIn} className="text-center mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
              {[
                ...
                { icon: Globe, label: "Downloads", value: "361,120+ · 6 Continents" },
          ...
          <Card className="bg-[#0f1a0f] border-emerald-900/40">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                The pack assembled. The lion documented them. The pack is now in the ICC submission. The lion has 47 consecutive perfect analytical scores, 589 verified propositions, and 361,000+ witnesses across 6 continents.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="bg-[#0a1a0a] border-emerald-500/30">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                The pack could not take down the lion. The ICC Article 7 submission is where the pack's conduct now lives permanently. 361,120+ downloads across 6 continents are the documented witnesses. 589/589 propositions verified with zero contradictions is the documented analytical record. The lion is still standing. The archive proves it.
              </p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    role: "10 Raleigh St Footscray 2011 co-tenancy = ICC exhibit · $500,000 ASIC-documented extraction · ATO drugging connection",
