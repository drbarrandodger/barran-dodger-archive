...
const collectionRules = [
  ...
  { prefix: 'client/public/evidence/', key: 'public-evidence', label: 'Public evidence', published: false },
  { prefix: 'client/public/audio/', key: 'public-audio', label: 'Public audio', published: false },
  { prefix: 'client/public/video/', key: 'public-video', label: 'Public video', published: false },
  { prefix: 'public/data/', key: 'public-metadata', label: 'Public metadata', published: false },
