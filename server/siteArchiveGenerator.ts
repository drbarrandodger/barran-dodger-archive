...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/significance-of-silence": "The Significance of Silence — 459,910 Downloads",
...
export function generateCertificatePDF(pagePath: string, generatedAt: string): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(7.5).font("Helvetica").fillColor("#444444")
      ...
      .text("492,544+ downloads across 501 pages   ·   Internationally referenced by UN agencies", 50, afterBox + 48, { width: W });
...
export async function generateSiteArchiveZip(res: Response): Promise<void> {
  ...
  res.setHeader("X-Total-Pages", String(TOTAL_PAGES));
  ...
  const readme = [
    ...
    "Complete Testimony Archive — " + TOTAL_PAGES + " Pages",
    "=".repeat(60),
    "",
    ...
    "for each of the " + TOTAL_PAGES + " pages of barrandodger.com.",
    ...
    "PAGE INDEX",
    "-".repeat(60),
    ...SITE_PATHS.map((p, i) => `  ${String(i + 1).padStart(3, " ")}. ${getTitle(p)}`),
    "",
